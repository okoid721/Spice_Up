...
const Navsmall = () => {
  ...
  return (
    <div className=" w-full bg-[aliceblue] lg:hidden block  shadow-xl py-6 sticky top-0 z-10 lg:px-6 px-2 ">
      <div className=" flex flex-row justify-between px-2 mb-2">
        ...
        <Link to="/home">
          <h1 className="font-extrabold lg:hidden block text-3xl ">SPICE_UP</h1>
        </Link>
      </div>
...
{
  /* <div
className=" flex lg:items-center lg:hidden  items-start flex-col justify-between lg:flex-row "
onClick={toggleMenu}
>
<button className=" w-8 h-8" onClick={() => setOpen(!open)}>
  <FaBarsStaggered size={30} />
